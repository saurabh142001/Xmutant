...
export default function NFTTable() {
  const [users, setUsers] = useState([
    ...
    { id: 15, name: "User z", imgUrl: "img/nft-aggregator/item-15.jpg", rewards: 200, walletAddress: "0xuvwyza...", timestamp: new Date('2024-05-15') }
  ]);
...
<div class="flex w-6/12 text-right cursor-pointer items-center justify-end " role="columnheader">
                 Rewards
                      <svg width="16" height="25" fill="none" xmlns="http://www.w3.org/2000/svg" class="ml-1">
                        <g clip-path="url(#clip0_2135_22855)">
                          <path d="M8 7.219l-3.3 3.3-.942-.943L8 5.333l4.243 4.243-.943.943-3.3-3.3z" fill="currentColor"></path>
                        </g>
                        <g clip-path="url(#clip1_2135_22855)">
